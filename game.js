...
function createGame(E,opts={}){
  ...
  function canUseReroll(){return !s.pendingCircuit&&(s.consumables?.reroll||0)>0&&!s.running&&!s.cleared&&!s.shopOpen&&s.failureReason!=='no-tiles'&&s.failureReason!=='placement-limit'}
  function reroll(){
