...
function createGame(E,opts={}){
  ...
  function snapshot(){
    ...
    return{
      ...
      schema:'iterion.run.v9',gameVersion:cfg.VERSION,engineVersion:cfg.ENGINE_VERSION,runId:s.runId,seed:s.seed,startedAt:s.startedAt,savedAt:new Date().toISOString(),
