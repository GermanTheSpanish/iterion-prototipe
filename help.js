(function(root,factory){
  ...
  function rulebookSections(){
    const sections={
      circuits:{id:'circuits',displayName:'Circuits',visual:'PHYSICAL LOOP → ONE TILE → RANK I–V',shortDescription:'Close a physical loop to develop one of its tiles.',rulesDescription:'A new loop of 4–6 / 7–9 / 10+ physical tiles awards +1 / +2 / +3 ranks to one tile you choose, capped at V. At most three Circuit Tiles may exist; once full, only an existing non-maxed Circuit Tile in the loop can develop. One Primary Circuit rewards per Move, and each physical cycle only once. Different overlapping cycles can develop the same tile. Circuit Tiles are black: white I, green II, blue III, purple IV, gold V pips. Their +50%, +100%, +200%, +400%, +800% Resonance bonuses add together and amplify final Main + Echo Output. Each activated physical tile counts once per Move. New ranks apply from the next Move. Stars remain separate.'},
