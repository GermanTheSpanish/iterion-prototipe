(function(root,factory){
  ...
  register({id:'undo',displayName:'UNDO',name:'UNDO',kind:'consumable',cost:4,shortDescription:'Store one undo.',rulesDescription:'Store one undo. Revert the last placement, including score, draw, coins and RNG state.',description:'Store one undo. Revert the last placement, including score, draw, coins and RNG state.'});
