(function(root,factory){
  ...
  const CASCADE=Object.freeze({introMs:Object.freeze([600,600,560,520,480,440]),tailMs:320,minMs:60,decay:0.70,maxLabels:8,retainedLabels:10,settleMs:300,resolveHoldMs:190,resolveFadeMs:180,finalMs:500,scoreTweenMs:360,subtotalHoldMs:240,settleItemMs:220,resonanceSettleMs:300,contributionLimit:8});
  ...
  function installUiPolish(root){
    ...
    const style=doc.createElement('style');style.id='nomon-ui-polish';style.textContent=`
      ...
      .signalValue small,.signalValue strong{display:none!important}.signalValue span{font-size:16px!important;font-weight:800!important;padding:3px 6px!important;border:1px solid rgba(21,21,21,.24)!important;border-radius:3px!important;background:rgba(251,250,246,.94)!important;color:#20201d!important}
      .signalValue[data-lane*="."]{display:grid!important;grid-template-columns:auto auto!important;gap:0 5px!important;padding:4px 5px!important;border:1px solid rgba(21,21,21,.2)!important;background:rgba(251,250,246,.94)!important}
