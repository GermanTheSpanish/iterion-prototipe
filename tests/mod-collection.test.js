...
assert.equal(slots.find(slot=>slot.key==='1|4').mod.id,'broker');
...
assert.equal(slots.find(slot=>slot.key==='3|5').mod.id,'spend');
...
assert.equal(slots.find(slot=>slot.key==='4|6').mod.id,'bank');
assert.equal(slots.find(slot=>slot.key==='5|5').mod.id,'toll');
