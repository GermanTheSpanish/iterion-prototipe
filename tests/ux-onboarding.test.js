...
assert.match(index,/ui-theme\.css\?v=20260926\.3/);
assert.doesNotMatch(index,/ux-pass\.css/);
assert.strictEqual(fs.existsSync(path.join(root,'ux-pass.css')),false);
assert.match(index,/tutorial-controller\.js\?v=entry-0311/);assert.match(index,/tutorial-controller\.js\?v=entry-0311[\s\S]*ux-pass\.js\?v=20260926\.3/);
assert.match(index,/mod-guidance\.js\?v=20260926\.3/);assert.match(index,/mod-guidance\.js[\s\S]*help\.js/);
