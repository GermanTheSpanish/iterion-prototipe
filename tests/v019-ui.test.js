...
assert.match(ui,/cascadeStructural reboundFx/,'Rebounds must be surfaced as structural events');
assert.doesNotMatch(ui,/updateOperationRepeat/,'Repeated arithmetic chip accumulation must stay removed');
assert.doesNotMatch(ui,/operationsSettledWith/,'Ephemeral arithmetic must not be retained through Score settlement');
