...
assert.match(help,/E\.connectionsForPiece\(piece,state\.pieces\|\|\[\]\)/);assert.match(help,/E\.applyOp\(value,isDouble,state,doubleDouble\)/);assert.doesNotMatch(ui,/E\.applyOp\(/);
