...
assert.strictEqual(D.VERSION,'0.47.0','build must identify as the current release');
assert.strictEqual(D.ENGINE_VERSION,'0.17.0-economy-v2','build must identify the current engine release');
