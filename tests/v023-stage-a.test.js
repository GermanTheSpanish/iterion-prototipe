...
assert.strictEqual(D.VERSION,'0.46.0','build must identify as the current release');
assert.strictEqual(D.ENGINE_VERSION,'0.16.0-signal-v2','build must identify the current engine release');
