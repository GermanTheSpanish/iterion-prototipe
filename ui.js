(function(){
  ...
  function renderInspector(){
    ...
    const longRunState=state.endlessMode?`LONG RUN · ${state.endlessLongRunActivations||0}/${D.ENDLESS_LONG_RUN_ACTIVATIONS||7} Endless activations used.`:'LONG RUN · at 10+ unique routed tiles, every activated star pays once.';
