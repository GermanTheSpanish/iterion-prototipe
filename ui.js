(function(){
  ...
  function showMarket(){
    ...
    const labels={'double-double':'DD','double-echo':'DE','triple-double':'TD','zero-port':'ZP','parity-exchange':'PX','corner':'CR','long-line':'LN','overload':'OV','terminal':'TE','sequence':'SQ','complement':'C6','twin':'TW','pair':'PR'},assignments=[];
